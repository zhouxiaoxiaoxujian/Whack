...
// This clas is a copy of starling.extensions.ParticleDesignerPS.  I was unable to extend the class due to some key properties being private.  
// The addition to this class is to allow for rotating the emitter.

package com.byxb.extensions.starling.extensions {
	...
	public class ParticleDesignerPS2 extends ParticleSystem
	{

		public function get emitterAngle():Number{return mEmitAngle; }
		public function set emitterAngle(angle:Number):void{ mEmitAngle = angle; }
		
		public function get speed():Number{return mSpeed; }
		public function set speed(speed:Number):void{ mSpeed = speed; }
		...
		public function ParticleDesignerPS2(config:XML, texture:Texture)
		{
			parseConfig(config);
